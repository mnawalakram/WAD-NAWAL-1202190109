...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <button href="Nawal_TambahBuku.php?" type="submit" class="btn btn-primary" name="submit">Tambah Buku</button>
        </div>
              ...
              <div class="container">
                <form method="post" action="Nawal_TambahBuku.php" enctype="multipart/form-data">                     
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="inputNama" placeholder="Nawal_1202190109" name="nama" value="Nawal_1202190109" readonly>
                        
                    </div>
                     
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label"><b>Tahun Terbit</b></label>
                        <input type="year" class="form-control" id="exampleInputEmail1" name="Judul" aria-describedby="emailHelp">
                        
                    </div>
                    
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label"><b>Deskripsi</b></label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Buku ini menjelaskan tentang....."></textarea>
                      </div>
                   ...
                   <div class="mb-3 mt-3">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="Pemrograman">
...
<center><footer style="margin-top: 3cm;">Nawal_1202190109</footer></center>
</body>
</html>
