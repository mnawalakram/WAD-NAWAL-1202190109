...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <button  type="button" class="btn btn-dark bg-gradient" onclick="window.location.href='register.php'" >Register</button>
        <button  type="button" class="btn btn-dark bg-gradient">Login</button>
        </div>        
    </div>
</nav>
          ...
          <div class="card-body">
          	...
          	<table width="100%">
                ...
                <tr>
          		...
          		<tr>
          			<td align="center">Anda belum punya akun ? <a href="register.php">Registrasi<a/></td>
          		</tr>
